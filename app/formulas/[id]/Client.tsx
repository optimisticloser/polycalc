...
export default function FormulaClient({ id }: FormulaClientProps) {
  ...
  const { setShowChatPanel } = useChatPanel();
  ...
  useEffect(() => {
    ...
    // Mostra o ChatPanel nas páginas de fórmulas
    setShowChatPanel(true);
    
    // Limpa o ChatPanel quando o componente é desmontado
    return () => setShowChatPanel(false);
  }, [formula.id, formula.defaults, queryVars, queryStep, setFormula, setMany, setStep, setShowChatPanel]);
